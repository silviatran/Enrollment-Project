...
class Utilities:
    ...
    @staticmethod
    def startup():
        cluster = "mongodb+srv://silviaatraanELvi7pbOyDj2G69C:ELvi7pbOyDj2G69C@studentenrollment.pmg57pi.mongodb.net/?retryWrites=true&w=majority&appName=StudentEnrollment"
        client = connect("StudentEnrollment", host=cluster, tlsCAFile=certifi.where())
        return client
        """
        try:
            junk = client.sever_info() #Test connection
            return client
